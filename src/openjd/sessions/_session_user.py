...
if is_windows():
    ...
    from ._win32._helpers import get_process_user, get_current_process_session_id

    CURRENT_PROCESS_RUNNING_IN_WINDOWS_SESSION_0: bool = 0 == get_current_process_session_id()
